...
public class Tempat_muziumkuching extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tempat_muziumkuching);
        ...
        btnLoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double latitude = 1.544765 ;
                double longtitude = 110.365219;

                String label = "Muzium Kuching";
